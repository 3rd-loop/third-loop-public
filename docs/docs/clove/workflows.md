...
Workflows are a way to make your work repeatable. They turn processes that you or your organization do over and over into structured, step-by-step templates that can be filled out and reused.
...
Each workflow is made up of steps. A step can include:

- **Step content** — What needs to happen at this stage.
- **User input requirements** — Whether someone needs to provide information at this step.
- **Clarifying questions** — Questions that help gather the right details.
- **Context and attachments** — Supporting documents or information attached to the step.
